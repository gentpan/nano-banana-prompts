...
category: landscape
style: 3d
tags: ["miniature diorama", "floating island", "punk style", "procedural generation", "isometric"]
source: ImgEdify/awesome-nano-banana-pro-prompts
license: MIT
---

# A random whimsical diorama generated using Nano banana 2. You can also get customized results by fil
...
- 提示词长度：约 10058 字符
- 风格分类：风景摄影
- 标签：miniature diorama, floating island, punk style, procedural generation, isometric
