...
category: landscape
style: 3d
tags: ["miniature diorama", "steampunk", "procedural generation", "floating island", "isometric view"]
source: ImgEdify/awesome-nano-banana-pro-prompts
license: MIT
---

# A random diorama scene from a random punk style generated using Nano banana pro. The prompt below ge
...
- 提示词长度：约 10025 字符
- 风格分类：风景摄影
- 标签：miniature diorama, steampunk, procedural generation, floating island, isometric view
...
Description — short world-appropriate description.

---

**整理：** Yep（[gentpan](https://github.com/gentpan)）  
**来源：** [ImgEdify/awesome-nano-banana-pro-prompts](https://x.com/artingent/status/2030717657813766480)  
**许可：** MIT
