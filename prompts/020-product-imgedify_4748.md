...
category: product
style: artistic
tags: ["digital collage", "street style", "graphic design chaos", "editorial fashion", "youth-oriented"]
source: ImgEdify/awesome-nano-banana-pro-prompts
license: MIT
---

# Prompt:  (access Nano Banana here: https://t.co/EY9xacrmOP)   [BRAND NAME]. Act as a Social Media Ar

## 中文

**产品摄影 - 详细型提示词**

这是一个关于 时尚 的 Gemini 图像生成提示词。

**关键特征：**
- 提示词长度：约 4891 字符
- 风格分类：产品摄影
- 标签：digital collage, street style, graphic design chaos, editorial fashion, youth-oriented
